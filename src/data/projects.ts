...
export const projects: Project[] = [
  ...
  },
  {
    id: 'medisync',
    name: 'MediSync',
    problem: 'Hospitals and clinics need a unified digital system to manage patient records, doctor schedules, appointments, and billing across multiple departments.',
    solution: 'Built a full-stack Hospital Management System with role-based access for admins, doctors, and patients, covering appointment scheduling, patient records, department management, and a real-time admin dashboard.',
    outcome: 'Production-ready full-stack platform demonstrating healthcare domain modelling, multi-role authentication, REST API design, and data-driven dashboards.',
    github: 'https://github.com/Alishaa-987/mediSync',
    live: null,
    language: 'TypeScript',
    tags: ['Next.js', 'TypeScript', 'PostgreSQL', 'Prisma', 'Tailwind CSS', 'JWT Auth'],
    category: 'fullstack',
    featured: false,
  },
  {
